// FIFA World Cup 2026 knockout-stage skeleton (ported verbatim from the PWA).
// API-Football has no bracket endpoint, so the tree's shape is hard-coded; real
// teams/scores are resolved at render time from Standings + Matches data.
